################################################################################
#
#   File name: RNAseq_expr_profiles_report.R
#
...
#
#	  Command line use example: Rscript RNAseq_expr_profiles_report.R  --sample_name CCR170012_MH17T001P013  --count_file ../data/CCR170012_MH17T001P013-ready.counts  --report_dir ../reports
#
...
if ( is.na(opt$sample_name) || is.na(opt$count_file) || is.na(opt$report_dir) ) {
  ...
  cat("\ncommand example:\n\nRscript RNAseq_expr_profiles_report.R  --sample_name CCR170012_MH17T001P013  --count_file ../data/CCR170012_MH17T001P013-ready.counts  --report_dir ../reports\n\n")
...
rmarkdown::render(input = "RNAseq_expr_profiles_report.Rmd", output_file = paste0(opt$sample_name, ".RNAseq_expr_profiles_report.html"), output_dir = opt$report_dir, params = list(report_dir = opt$report_dir, sample_name = opt$sample_name, count_file = opt$count_file))
