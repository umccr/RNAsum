...
##### TODO (PD): Add column to flag fusions supported by WGS data (from MANTA), if available
fusions_arriba$geneA_dna_support <- "-"
fusions_arriba$geneB_dna_support <- "-"
```
...
##### TODO (PD): Add column to flag fusions supported by WGS data (from MANTA), if available
fusions_dragen$geneA_dna_support <- "-"
fusions_dragen$geneB_dna_support <- "-"
```
