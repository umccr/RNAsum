...
# rownames(genes_cancer) <- genes_cancer[["Hugo_Symbol"]]
names(tmpg) <- c("Gene", "Gene panels no.", "OncoKB", "Oncogene (OncoKB)", "TSG (OncoKB)", "MSK-IMPACT", "MSK-HEME", "Foundation One", "Foundation One Heme", "Vogelstein", "Sanger CGC", "UMCCR", "Oncogene", "TSG", "Fusion", "Germline")
...
ref_genes.list[["genes_oncokb"]] <- genes_cancer[rownames(genes_cancer) %in% ref_genes.list[["genes_oncokb"]]$Hugo_Symbol, ]
##### Clean the space
rm(genes_cancer)
```
