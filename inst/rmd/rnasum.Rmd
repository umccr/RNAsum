...
salmon_counts <- function(dragen_rnaseq, tx2ensembl) {
  quant_file <- list.files(dragen_rnaseq, pattern = ".quant.sf$", full.names = TRUE)
...
counts <- salmon_counts(dragen_rnaseq = params$dragen_rnaseq, tx2ensembl = tx2ensembl)
