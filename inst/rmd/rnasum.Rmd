...
sample_name <- dplyr::if_else(dataset_name_incl == "", params$sample_name,
  as.character(glue::glue("{params$sample_name}_{dataset}"))
)
results_dir <- file.path(
  params$report_dir,
  glue::glue("{params$sample_name}{dataset_name_incl}.results")
)
