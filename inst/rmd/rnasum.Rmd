...
assertthat::assert_that(all(expr_data.perc[["SYMBOL"]] == expr_data.z[["SYMBOL"]]))
...
##### Clean the space
rm(cn_data, cn_data.sub, expr_data, gene.mut, targets, expr_data.z, expr_data.perc, expr_genes)
```
