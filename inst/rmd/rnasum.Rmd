...
ucsc_genome_assembly <- dplyr::if_else(params$grch_version == 38, 38L, 19L)
ensembl_version <- dplyr::if_else(params$grch_version == 38, 86L, 75L)
...
arriba_summary_out <-
  glue::glue("{sample_name}{dataset_name_incl}.RNAseq_report.arriba_fusions.txt")
...
# This part outputs a vector with first element containing the merged data and second element containing merged targets info.
