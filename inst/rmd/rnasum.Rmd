...
subjectID <- dplyr::if_else(is.null(params$subject_id), "", params$subject_id)
subjectID <- dplyr::if_else(is.null(params$umccrise), subjectID, basename(params$umccrise))
sample_name <- paste0(
  params$sample_name,
...
int_cancer_group <- ref_dataset[["int_ref"]][["dataset"]]
ext_cancer_group <- ref_dataset[["ext_ref"]][["dataset"]]
