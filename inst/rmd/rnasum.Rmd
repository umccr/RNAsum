...
#### edb was generated using the RNAsum::get_edb function, and is included in RNAsum under inst/extdata/
tx2ensembl <- RNAsum::get_ensembl_db(here::here("inst/extdata/edb_105.rds"))
