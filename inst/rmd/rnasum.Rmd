...
arriba_out <- glue::glue(
  "{params$sample_name}{params$dataset_name_incl}",
  ".RNAseq_report.arriba_fusions.txt"
)
RNAsum::arriba_write(sample_data.list[["arriba_pdf"]], file = file.path(results_dir, arriba_out))



##### Read in sample WGS data
