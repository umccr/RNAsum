...
(where the report is written), and `TESTDATA` (input data directory) are
required. Point `TESTDATA` at the bundled test data under `inst/rawdata/test_data` or at your own inputs:
