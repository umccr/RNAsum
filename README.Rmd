...
5. The final product is an interactive HTML report with searchable tables and
   ...
   consists of several sections described [here](./isnt/articles/report_structure.md).
...
**[Pan-Cancer dataset](./inst/articles/articles/tcga_projects_summary.md#pan-cancer-dataset)**,
