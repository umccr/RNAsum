...
```{r cn_data_distribution_plot, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 8, eval = runPurpleChunk }
...
if ( params$plots_mode == "static" ) {
  ...
  ##### Save the static image into a file
  orca(cn_dist_plot, format = "png", file = "cn_data_dist_plot.png", width = 800, height = 600)
