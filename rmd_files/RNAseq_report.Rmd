...
`r if ( genes_no > 2000 ) { c(paste0("<span style=\"color:#ff0000\">NOTE</span>, the table was trimmed from ", genes_no, " to 2000 entries.")) } else { cat("") }`
...
if ( genes_no > 0 ) {
  for( i in 1:genes_no ) {
    ...
    if ( genes_no > 2000 ) { 
        cat(paste0("<span style=\"color:#ff0000\">NOTE</span>, the table was trimmed from ", genes_no, " to 2000 entries.")) 
    }
...
`r if ( genes_gains_no > 2000 ) { c(paste0("<span style=\"color:#ff0000\">NOTE</span>, the table was trimmed from ", genes_gains_no, " to 2000 entries.")) } else { cat("") }`
...
`r if ( genes_losses_no > 2000 ) { c(paste0("<span style=\"color:#ff0000\">NOTE</span>, the table was trimmed from ", genes_losses_no, " to 2000 entries.")) } else { cat("") }`
