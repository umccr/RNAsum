...
NOTE: currently, displaying the top hits from pizzly filtering output (<span style="color:#ff0000">red</span> and <span style="color:#0000ff">blue</span> sections in [Fusion events prioritisation] table). Also, in the following visualization section, the missing hits from the prioritized results are the ones for which no junctions are found by clinker.
