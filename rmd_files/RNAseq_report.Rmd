...
[PCGR](https://github.com/sigven/pcgr){target="_blank"} report for this sample is **`r if ( runPcgrChunk ) { c("AVAILABLE") } else { c("NOT AVAILABLE") }`**. 
...
[Manta](https://github.com/sigven/pcgr){target="_blank"} results for this sample are **`r if ( runSVsChunk ) { c("AVAILABLE") } else { c("NOT AVAILABLE") }`**. 
...
[PURPLE](https://anaconda.org/bioconda/hmftools-purple){target="_blank"} report for this sample is **`r if ( runPurpleChunk ) { c("AVAILABLE") } else { c("NOT AVAILABLE") }`**.
