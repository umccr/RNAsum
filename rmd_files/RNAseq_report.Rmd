...
author: '`r paste0(Sys.info()["user"], " (", Sys.info()["nodename"], ")")`'
date: '`r Sys.Date()`'
output:
  html_document:
    keep_md: yes
...
params:
  ...
  dataset: "pdac"
  count_file: "/Users/kanwals/Documents/UMCCR/git/RNAseq-report/RNAseq-Analysis-Report/data/test_data/final/test_sample_WTS/kallisto/abundance.tsv"
  report_dir: 
  transform: 
  filter: 
  norm: 
...
ref_datasets.list[[dataset]] <- combineDatasets(params$sample_name, kallisto.counts, ref_dataset[[dataset]][1])
