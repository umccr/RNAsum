...
civicDrugTable(genes = unique(genesA, genesB), civic_var_summaries  = caner_genes_annot.list[["civic_var_summaries"]], civic_clin_evid  = caner_genes_annot.list[["civic_clin_evid"]],  evid_type = "Predictive", var_type = "fusion")[[1]]
```
...
##### Generate table with drugs targeting fusion genes
civicDrugTable(genes = unique(genesA, genesB), civic_var_summaries  = caner_genes_annot.list[["civic_var_summaries"]], civic_clin_evid  = caner_genes_annot.list[["civic_clin_evid"]],  evid_type = "Prognostic", var_type = "fusion")[[1]]
```
...
##### Generate table with drugs targeting fusion genes
civicDrugTable(genes = unique(genesA, genesB), civic_var_summaries  = caner_genes_annot.list[["civic_var_summaries"]], civic_clin_evid  = caner_genes_annot.list[["civic_clin_evid"]],  evid_type = "Diagnostic", var_type = "fusion")[[1]]
```
...
##### Generate table with drugs targeting fusion genes
civicDrugTable(genes = unique(genesA, genesB), civic_var_summaries  = caner_genes_annot.list[["civic_var_summaries"]], civic_clin_evid  = caner_genes_annot.list[["civic_clin_evid"]],  evid_type = "Predisposing", var_type = "fusion")[[1]]
```
