...
params:
  ...
  pizzly_results: '../data/pizzly'
  kallisto_results: '../data/kallisto'
  clinker_results: '../data/clinker'
...
pizzly.fusions <- read.table(file = paste(params$pizzly_results, "pizzly-flat-filtered.tsv", sep = "/"), header = TRUE)
quant <- read.table(file = paste(params$kallisto_results, "abundance.tsv", sep = "/"), header = TRUE)
...
fusion_png(geneA, geneB, params$clinker_results )
```
...
fusion_png(pizzly.fusions2$geneA.name[4], pizzly.fusions2$geneB.name[4], params$clinker_results )
```
