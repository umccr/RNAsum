...
<span style="color:#ff0000">NOTE</span>: currently, displaying the 5 genes with the highest (**gains**) and 5 genes with the lowest (**losses**) CN values and the greatest difference in standarised (Z-score) mRNA expression values between patient's sample and the average mRNA expression in samples from healthy  individuals.
