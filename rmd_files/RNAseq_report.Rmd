...
##### Otherwise do not execute CN related chunks 
} else {
...
NOTE: the `r nrow(counts) - nrow(y.filtered$counts)` genes with no/low expression are indicated in <span style="color:#808080">BLANK</span> cells with missing values in *expression summary tables* in [Mutated genes], [Copy-number altered genes], [Cancer genes] and [Immune Response Markers] sections.
...
#### `r mut_genes.expr.z[[2]]$SYMBOL[10]`
...
Section overlaying the mRNA expression data with per-gene somatic copy-number (CN) data and, where available, mutation status. `r if ( !runChunk) { cat("No CN data was provided.\n\n") }`
...
```{r mut_cn_expr_data_plot, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 3, eval = runChunk}
##### Generate scatterplot with per-gene expression values (y-axis), CN values (x-axis) and mutation status info (colours)
suppressMessages(library(plotly))
...
```{r mut_cn_expr_data_table_gains, comment = NA, message=FALSE, warning=FALSE, eval = runChunk}
...
```{r mut_cn_expr_data_table_gains_perc, comment = NA, message=FALSE, warning=FALSE, eval = runChunk}
##### Generate expression summary table for per-gene expression values CN values and mutation status info (colours)
if ( !is.null(ref_genes.list[["pcgr"]]) && !is.null(ref_genes.list[["purple"]]) ) {
...
```{r mut_cn_expr_data_table_losses, comment = NA, message=FALSE, warning=FALSE, eval = runChunk}
##### Generate expression summary table for per-gene expression values CN values and mutation status info (colours)
...
```{r mut_cn_expr_data_table_losses_perc, comment = NA, message=FALSE, warning=FALSE, eval = runChunk}
##### Generate expression summary table for per-gene expression values CN values and mutation status info (colours)
if ( !is.null(ref_genes.list[["pcgr"]]) && !is.null(ref_genes.list[["purple"]]) ) {
...
##### `r if ( runChunk) { mut_cn_expr_genes.expr.gains.z[[2]]$SYMBOL[1] } else { cat("No CN data was provided.\n\n") }`

```{r cdf_plot_mut_cn_expr_gains_genes_1, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 3, eval = runChunk}
suppressMessages(library(plotly))
...
##### `r if ( runChunk) { mut_cn_expr_genes.expr.gains.z[[2]]$SYMBOL[2] } else { cat("No CN data was provided.\n\n") }`

```{r cdf_plot_mut_cn_expr_gains_genes_2, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 3, eval = runChunk}
suppressMessages(library(plotly))
...
##### `r if ( runChunk) { mut_cn_expr_genes.expr.gains.z[[2]]$SYMBOL[3] } else { cat("No CN data was provided.\n\n") }`

```{r cdf_plot_mut_cn_expr_gains_genes_3, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 3, eval = runChunk}
suppressMessages(library(plotly))
...
##### `r if ( runChunk) { mut_cn_expr_genes.expr.gains.z[[2]]$SYMBOL[4] } else { cat("No CN data was provided.\n\n") }`

```{r cdf_plot_mut_cn_expr_gains_genes_4, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 3, eval = runChunk}
suppressMessages(library(plotly))
...
##### `r if ( runChunk) { mut_cn_expr_genes.expr.gains.z[[2]]$SYMBOL[5] } else { cat("No CN data was provided.\n\n") }`

```{r cdf_plot_mut_cn_expr_gains_genes_5, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 3, eval = runChunk}
suppressMessages(library(plotly))
...
##### `r if ( runChunk) { mut_cn_expr_genes.expr.losses.z[[2]]$SYMBOL[1] } else { cat("No CN data was provided.\n\n") }`

```{r cdf_plot_mut_cn_expr_losses_genes_1, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 3, eval = runChunk}
suppressMessages(library(plotly))
...
##### `r if ( runChunk) { mut_cn_expr_genes.expr.losses.z[[2]]$SYMBOL[2] } else { cat("No CN data was provided.\n\n") }`

```{r cdf_plot_mut_cn_expr_losses_genes_2, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 3, eval = runChunk}
suppressMessages(library(plotly))
...
##### `r if ( runChunk) { mut_cn_expr_genes.expr.losses.z[[2]]$SYMBOL[3] } else { cat("No CN data was provided.\n\n") }`

```{r cdf_plot_mut_cn_expr_losses_genes_3, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 3, eval = runChunk}
suppressMessages(library(plotly))
...
##### `r if ( runChunk) { mut_cn_expr_genes.expr.losses.z[[2]]$SYMBOL[4] } else { cat("No CN data was provided.\n\n") }`

```{r cdf_plot_mut_cn_expr_losses_genes_4, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 3, eval = runChunk}
suppressMessages(library(plotly))
...
##### `r if ( runChunk) { mut_cn_expr_genes.expr.losses.z[[2]]$SYMBOL[5] } else { cat("No CN data was provided.\n\n") }`

```{r cdf_plot_mut_cn_expr_losses_genes_5, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 3, eval = runChunk}
suppressMessages(library(plotly))
...
cancer_genes.expr.z <- exprTable( genes = rownames(ref_genes.list[["oncokb_genes"]]), data = data, targets = targets, sampleName = params$sample_name, normal = normal_group , cancer = cancer_group, genes_annot = ref_datasets.list[[tissue]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], OncoKB_genes = ref_genes.list[["oncokb_genes"]], ext_links = TRUE, type = "z")
...
cancer_genes.expr.perc <- exprTable( genes = rownames(ref_genes.list[["oncokb_genes"]]), data = data, targets = targets, sampleName = params$sample_name, normal = normal_group , cancer = cancer_group, genes_annot = ref_datasets.list[[tissue]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], OncoKB_genes = ref_genes.list[["oncokb_genes"]], ext_links = TRUE, type = "perc")
...
exprTable( genes = fusion.df$SYMBOL, data = data, targets = targets, sampleName = params$sample_name, normal = normal_group, cancer = cancer_group, genes_annot = ref_datasets.list[[tissue]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], OncoKB_genes = ref_genes.list[["oncokb_genes"]][,c("Oncogene", "TSG", "OncoKB")], fusion_genes = fusion_annot_reported, ext_links = TRUE, type = "z")[[1]]
```
...
#### `r paste(pizzly.fusions2$geneA.name[5], pizzly.fusions2$geneB.name[5], sep="-")`
...
```{r fusions_tables_5, comment = NA, message=TRUE, warning=FALSE}
##### Present a table with number of reads supporting this fusion
##### Check if clinker fusion plot exists. Skip this section in it doesn't
if ( file.exists( paste0(dataDir, "/clinker/", geneA, "_", geneB, ".pdf")) ) {
...
List of suitable drugs based on actionable targets identified among [Mutated genes], 
[Copy-number altered genes], dysregulated [Cancer genes] and [Gene fusion events], which can be considered in the treatment decision making process. The clinically actionable aberrations are matched based on information provided by *[clinical interpretations of variants in Cancer](https://civicdb.org/home){target="_blank"}* (CIViC) ([Griffith et al. (2017)](https://www.ncbi.nlm.nih.gov/pubmed/28138153){target="_blank"}).

### - Mutated genes {.tabset}

Genes with PCGR [tier 1-3](https://pcgr.readthedocs.io/en/latest/tier_systems.html#tier-model-2-pcgr-acmg){target="_blank"} variants were screened for suitable drugs (see [Mutated genes] section).
...
civicDrugTable(genes, caner_genes_annot.list[["civic_var_summaries"]], caner_genes_annot.list[["civic_clin_evid"]], "Predictive", var_type = "mutation")[[1]]
```
...
Genes with CN values > `r params$cn_gain` (**gains**) and  or < `r params$cn_loss` (**losses**) were screened for suitable drugs (see [Copy-number altered genes] section).
...
```{r drugs_predictive_CN_altered_genes_gains, comment = NA, message=FALSE, warning=FALSE, eval = runChunk}
...
```{r drugs_prognostic_CN_altered_genes_gains, comment = NA, message=FALSE, warning=FALSE, eval = runChunk}
##### Generate table with drugs targeting CN altered genes
civicDrugTable(genes, caner_genes_annot.list[["civic_var_summaries"]], caner_genes_annot.list[["civic_clin_evid"]], "Prognostic")[[1]]
```
...
```{r drugs_diagnostic_CN_altered_genes_gains, comment = NA, message=FALSE, warning=FALSE, eval = runChunk}
##### Generate table with drugs targeting CN altered genes
civicDrugTable(genes, caner_genes_annot.list[["civic_var_summaries"]], caner_genes_annot.list[["civic_clin_evid"]], "Diagnostic")[[1]]
```
...
```{r drugs_predisposing_CN_altered_genes_gains, comment = NA, message=FALSE, warning=FALSE, eval = runChunk}
##### Generate table with drugs targeting CN altered genes
civicDrugTable(genes, caner_genes_annot.list[["civic_var_summaries"]], caner_genes_annot.list[["civic_clin_evid"]], "Predisposing")[[1]]
```
...
```{r drugs_predictive_CN_altered_genes_losses, comment = NA, message=FALSE, warning=FALSE, eval = runChunk}
##### Generate table with drugs targeting CN altered genes
...
```{r drugs_prognostic_CN_altered_genes_losses, comment = NA, message=FALSE, warning=FALSE, eval = runChunk}
##### Generate table with drugs targeting CN altered genes
civicDrugTable(genes, caner_genes_annot.list[["civic_var_summaries"]], caner_genes_annot.list[["civic_clin_evid"]], "Prognostic")[[1]]
```
...
```{r drugs_diagnostic_CN_altered_genes_losses, comment = NA, message=FALSE, warning=FALSE, eval = runChunk}
##### Generate table with drugs targeting CN altered genes
civicDrugTable(genes, caner_genes_annot.list[["civic_var_summaries"]], caner_genes_annot.list[["civic_clin_evid"]], "Diagnostic")[[1]]
```
...
```{r drugs_predisposing_CN_altered_genes_losses, comment = NA, message=FALSE, warning=FALSE, eval = runChunk}
##### Generate table with drugs targeting CN altered genes
civicDrugTable(genes, caner_genes_annot.list[["civic_var_summaries"]], caner_genes_annot.list[["civic_clin_evid"]], "Predisposing")[[1]]
```
...
Gene fusion events involving highly abundant transcripts and cancer genes (<span style="color:#ff0000">red</span> and <span style="color:#0000ff">blue</span> sections in [Gene fusion events] table) were screened for suitable drugs.
