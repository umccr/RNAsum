...
fusion_pdf <- paste(params$pizzly_folder, paste0(pizzly.fusions2$geneA.name[1], "_", pizzly.fusions2$geneB.name[1], ".pdf"), sep = "/")

#export pdf to png
fusion_png <- paste(params$pizzly_folder, paste0(pizzly.fusions2$geneA.name[1], "_", pizzly.fusions2$geneB.name[1], ".png"), sep = "/")
...
#get path to fusion visualization pdf file
fusion_pdf <- paste(params$pizzly_folder, paste0(pizzly.fusions2$geneA.name[2], "_", pizzly.fusions2$geneB.name[2], ".pdf"), sep = "/")

#export pdf to png
fusion_png <- paste(params$pizzly_folder, paste0(pizzly.fusions2$geneA.name[2], "_", pizzly.fusions2$geneB.name[2], ".png"), sep = "/")
fusion <- image_read_pdf(fusion_pdf, pages = NULL, density = 300)
image_write(fusion, path = fusion_png, format = "png")
...
#get path to fusion visualization pdf file
fusion_pdf <- paste(params$pizzly_folder, paste0(pizzly.fusions2$geneA.name[3], "_", pizzly.fusions2$geneB.name[3], ".pdf"), sep = "/")

#export pdf to png
fusion_png <- paste(params$pizzly_folder, paste0(pizzly.fusions2$geneA.name[3], "_", pizzly.fusions2$geneB.name[3], ".png"), sep = "/")
fusion <- image_read_pdf(fusion_pdf, pages = NULL, density = 300)
image_write(fusion, path = fusion_png, format = "png")
...
Box-plot illustrating mRNA expression level of ***`r ref_genes.list[["genes_fusions"]][1,]`*** (y-axis) in sample **`r params$sample_name`** and its expression distribution in samples representing various pancreas-related lesions/tissues (x-axis).

```{r box_plot_fusions_1, comment = NA, message=FALSE, warning=FALSE, fig.width = 7, fig.height = 4}
suppressMessages(library(plotly))
##### Generate PCA plots for pancreatic related lesions
...
Box-plot illustrating mRNA expression level of ***`r ref_genes.list[["genes_fusions"]][2,]`*** (y-axis) in sample **`r params$sample_name`** and its expression distribution in samples representing various pancreas-related lesions/tissues (x-axis).

```{r box_plot_fusions_2, comment = NA, message=FALSE, warning=FALSE, fig.width = 7, fig.height = 4}
suppressMessages(library(plotly))
##### Generate PCA plots for pancreatic related lesions
target <- target$Target
...
Box-plot illustrating mRNA expression level of ***`r ref_genes.list[["genes_fusions"]][3,]`*** (y-axis) in sample **`r params$sample_name`** and its expression distribution in samples representing various pancreas-related lesions/tissues (x-axis).

```{r box_plot_fusions_3, comment = NA, message=FALSE, warning=FALSE, fig.width = 7, fig.height = 4}
suppressMessages(library(plotly))
##### Generate PCA plots for pancreatic related lesions
target <- target$Target
...
Box-plot illustrating mRNA expression level of ***`r ref_genes.list[["genes_fusions"]][4,]`*** (y-axis) in sample **`r params$sample_name`** and its expression distribution in samples representing various pancreas-related lesions/tissues (x-axis).

```{r box_plot_fusions_4, comment = NA, message=FALSE, warning=FALSE, fig.width = 7, fig.height = 4}
suppressMessages(library(plotly))
##### Generate PCA plots for pancreatic related lesions
target <- target$Target
...
Box-plot illustrating mRNA expression level of ***`r ref_genes.list[["genes_fusions"]][5,]`*** (y-axis) in sample **`r params$sample_name`** and its expression distribution in samples representing various pancreas-related lesions/tissues (x-axis).

```{r box_plot_fusions_5, comment = NA, message=FALSE, warning=FALSE, fig.width = 7, fig.height = 4}
suppressMessages(library(plotly))
##### Generate PCA plots for pancreatic related lesions
target <- target$Target
...
Box-plot illustrating mRNA expression level of ***`r ref_genes.list[["genes_fusions"]][6,]`*** (y-axis) in sample **`r params$sample_name`** and its expression distribution in samples representing various pancreas-related lesions/tissues (x-axis).

```{r box_plot_fusions_6, comment = NA, message=FALSE, warning=FALSE, fig.width = 7, fig.height = 4}
suppressMessages(library(plotly))
##### Generate PCA plots for pancreatic related lesions
target <- target$Target
...
Box-plot illustrating mRNA expression level of ***`r ref_genes.list[["genes_fusions"]][7,]`*** (y-axis) in sample **`r params$sample_name`** and its expression distribution in samples representing various pancreas-related lesions/tissues (x-axis).

```{r box_plot_fusions_7, comment = NA, message=FALSE, warning=FALSE, fig.width = 7, fig.height = 4}
suppressMessages(library(plotly))
##### Generate PCA plots for pancreatic related lesions
target <- target$Target
...
Box-plot illustrating mRNA expression level of ***`r ref_genes.list[["genes_pmcc"]][1,]`*** (y-axis) in sample **`r params$sample_name`** and its expression distribution in samples representing various pancreas-related lesions/tissues (x-axis).

```{r box_plot_pmcc_1, comment = NA, message=FALSE, warning=FALSE, fig.width = 7, fig.height = 4}
suppressMessages(library(plotly))
##### Generate PCA plots for pancreatic related lesions
target <- target$Target
...
Box-plot illustrating mRNA expression level of ***`r ref_genes.list[["genes_pmcc"]][2,]`*** (y-axis) in sample **`r params$sample_name`** and its expression distribution in samples representing various pancreas-related lesions/tissues (x-axis).

```{r box_plot_pmcc_2, comment = NA, message=FALSE, warning=FALSE, fig.width = 7, fig.height = 4}
suppressMessages(library(plotly))
##### Generate PCA plots for pancreatic related lesions
target <- target$Target
...
Box-plot illustrating mRNA expression level of ***`r ref_genes.list[["genes_pmcc"]][3,]`*** (y-axis) in sample **`r params$sample_name`** and its expression distribution in samples representing various pancreas-related lesions/tissues (x-axis).

```{r box_plot_pmcc_3, comment = NA, message=FALSE, warning=FALSE, fig.width = 7, fig.height = 4}
suppressMessages(library(plotly))
##### Generate PCA plots for pancreatic related lesions
target <- target$Target
...
Box-plot illustrating mRNA expression level of ***`r ref_genes.list[["genes_pmcc"]][4,]`*** (y-axis) in sample **`r params$sample_name`** and its expression distribution in samples representing various pancreas-related lesions/tissues (x-axis).

```{r box_plot_pmcc_4, comment = NA, message=FALSE, warning=FALSE, fig.width = 7, fig.height = 4}
suppressMessages(library(plotly))
##### Generate PCA plots for pancreatic related lesions
target <- target$Target
...
Box-plot illustrating mRNA expression level of ***`r ref_genes.list[["genes_pmcc"]][5,]`*** (y-axis) in sample **`r params$sample_name`** and its expression distribution in samples representing various pancreas-related lesions/tissues (x-axis).

```{r box_plot_pmcc_5, comment = NA, message=FALSE, warning=FALSE, fig.width = 7, fig.height = 4}
suppressMessages(library(plotly))
##### Generate PCA plots for pancreatic related lesions
target <- target$Target
