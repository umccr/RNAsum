...
if ( params$filter ) {
  ...
  counts_vs_transformed <- plot_ly( data.df, x = ~Transformed, y = ~Counts, width = 600, height = 300, color = I('black'), marker = list(size = 5), type="scatter", mode = "markers", name = paste0(params$transform, " / Counts (Patient)") ) %>% 
