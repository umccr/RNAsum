...
List of suitable drugs based on actionable targets identified among dysregulated genes and fusion events based, which can be considered in the treatment decision making process. The clinically actionable aberrations are matched based on information provided by *[CIViC](https://civicdb.org/home){target="_blank"}* ([Griffith et al. (2017)](https://www.ncbi.nlm.nih.gov/pubmed/28138153)).
