...
if ( !is.null(params$wgs_dir) ) {
  ...
  if ( file.exists(paste0(params$wgs_dir, "/small_variants/", list.files(paste0(params$wgs_dir, "/small_variants/"), pattern="-somatic.pcgr.snvs_indels.tiers.tsv$"))) ) {
    pcgr_file <- paste0(params$wgs_dir, "/small_variants/", list.files(paste0(params$wgs_dir, "/small_variants/"), pattern="-somatic.pcgr.snvs_indels.tiers.tsv$"))
  } else if ( file.exists(paste0(params$wgs_dir, "/pcgr/", list.files(paste0(params$wgs_dir, "/pcgr/"), pattern="-somatic.pcgr.snvs_indels.tiers.tsv$"))) ) {
    pcgr_file <- paste0(params$wgs_dir, "/pcgr/", list.files(paste0(params$wgs_dir, "/pcgr/"), pattern="-somatic.pcgr.snvs_indels.tiers.tsv$"))
  } else if ( file.exists(paste0(params$wgs_dir, "/pcgr/", list.files(paste0(params$wgs_dir, "/pcgr/"), pattern="-somatic.pcgr_acmg.grch37.snvs_indels.tiers.tsv$"))) ) {
    pcgr_file <- paste0(params$wgs_dir, "/pcgr/", list.files(paste0(params$wgs_dir, "/pcgr/"), pattern="-somatic.pcgr_acmg.grch37.snvs_indels.tiers.tsv$"))
  } else {
    runPcgrChunk <- FALSE
  }
