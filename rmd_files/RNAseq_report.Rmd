...
<span style="color:#ff0000">NOTE</span>: no plot in the *Fusion events visualisation* section is available for gene fusions for which no junctions were found by [clinker](https://github.com/Oshlack/Clinker){target="_blank"}.
...
List of suitable drugs based on actionable targets identified among [mutated genes](#Mutated genes), 
[copy-number (CN) altered genes](#Copy-number altered genes), [dysregulated cancer genes](#Cancer genes) and [fusion events](#Gene fusion events), which can be considered in the treatment decision making process. The clinically actionable aberrations are matched based on information provided by *[clinical interpretations of variants in Cancer](https://civicdb.org/home){target="_blank"}* (CIViC) ([Griffith et al. (2017)](https://www.ncbi.nlm.nih.gov/pubmed/28138153){target="_blank"}).
