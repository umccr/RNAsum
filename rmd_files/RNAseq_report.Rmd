...
<span style="color:#ff0000">NOTE</span>: This section is available for samples with accompanying [PCGR](https://github.com/sigven/pcgr){target="_blank"} results.
...
Section overlaying the mRNA expression data with per-gene somatic copy-number (CN) data and mutation status, if available.

<span style="color:#ff0000">NOTE</span>: This section is available for samples with accompanying [PURPLE](https://anaconda.org/bioconda/hmftools-purple){target="_blank"} results.
