...
```{r fusion_1_plot, comment = NA, message=TRUE, warning=FALSE, eval=runPizzlyChunk}
...
```{r fusion_2_plot, comment = NA, message=TRUE, warning=FALSE, eval=runPizzlyChunk}
##### Check if clinker fusion plot exists. Skip this section if it doesn't
fusion_png(geneA, geneB, paste(dataDir, "clinker", sep="/") )
clinker_fusions <- c(clinker_fusions, paste0(geneA, "-", geneB))
```
...
```{r fusion_3_plot, comment = NA, message=TRUE, warning=FALSE, eval=runPizzlyChunk}
##### Check if clinker fusion plot exists. Skip this section if it doesn't
fusion_png(geneA, geneB, paste(dataDir, "clinker", sep="/") )
clinker_fusions <- c(clinker_fusions, paste0(geneA, "-", geneB))
```
...
```{r fusion_4_plot, comment = NA, message=TRUE, warning=FALSE, eval=runPizzlyChunk}
##### Check if clinker fusion plot exists. Skip this section if it doesn't
fusion_png(geneA, geneB, paste(dataDir, "clinker", sep="/") )
clinker_fusions <- c(clinker_fusions, paste0(geneA, "-", geneB))
```
...
```{r fusion_5_plot, comment = NA, message=TRUE, warning=FALSE, eval=runPizzlyChunk}
##### Check if clinker fusion plot exists. Skip this section if it doesn't
fusion_png(geneA, geneB, paste(dataDir, "clinker", sep="/") )
clinker_fusions <- c(clinker_fusions, paste0(geneA, "-", geneB))
```
