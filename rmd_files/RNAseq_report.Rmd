...
Expression profiles for 10 altered [cancer genes](https://trello.com/c/7j3KFMiL/184-umccr-cancer-genes){target="_blank"} with the greatest difference in standarised (Z-score) mRNA expression values between patient's sample and the average mRNA expression in samples from healthy individuals.
...
**[Cancer gene(s)](https://trello.com/c/7j3KFMiL/184-umccr-cancer-genes){target="_blank"}**: gene fusion events involving [Cancer genes]
...
**50** [cancer genes](https://trello.com/c/7j3KFMiL/184-umccr-cancer-genes){target="_blank"} with the greatest difference in standarised (Z-score) mRNA expression values between patient's sample and the average mRNA expression in samples from healthy individuals were screened for suitable drugs (see [Cancer genes] section).
...
**`r nrow(pizzly.fusions.cut[ pizzly.fusions.cut$reported_fusion == "Yes" , ])`** gene fusions **reported in [FusionGDB](https://ccsm.uth.edu/FusionGDB){target="_blank"}** and **`r nrow(pizzly.fusions.cut[ pizzly.fusions.cut$geneA_dna_support == "Yes" | pizzly.fusions.cut$geneB_dna_support == "Yes" , ])`** involving DNA-supported fusion genes (see [Structural variants] section), abundant transcripts or [cancer genes](https://trello.com/c/7j3KFMiL/184-umccr-cancer-genes){target="_blank"} (see [Cancer genes] section), indicated in <span style="color:#02d653">green</span>, <span style="color:#ff0000">red</span> and <span style="color:#0000ff">blue</span> columns in the [Gene fusion events] table, respectively, and with the highest *Split count* and *Pair count* values were screened for suitable drugs.
