...
names(pizzly.fusions.table) <- c("Gene A", "Gene B", "Pair count", "Split count", "Abundant transcript(s)", "Cancer gene(s)", "DNA evidence (gene A)", "DNA evidence (gene B)", "Fusion gene(s)", "Effector gene", "Source", "Cancer acronym")
...
fusion_annot_top <- fusion_annot[ fusion_annot$geneA_dna_evidence == "Yes" | fusion_annot$geneB_dna_evidence == "Yes" , ]
