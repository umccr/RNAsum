...
output:
  ...
  rmdformats::material:
    highlight: kate
params:
  report_dir: '/Users/jmarzec/data/Patients/final/PRJ190059_SUPER/RNAseq_report'
  sample_name: 'PRJ190059_SUPER'
  count_file: '/Users/jmarzec/data/Patients/final/PRJ190059_SUPER/PRJ190059_SUPER-ready.counts'
  tissue: 'pancreas'
  plots_mode: 'static'
  batch: '/Users/jmarzec/data/Patients/umccrised/CUP-Pairs7__PRJ180659_7_DNA004900_FFPE'
  ref_data_dir: '../data'
...
* **`r paste(ref_normal, ext_cancer_group, sep=" ")`** samples from [The Cancer Genome Atlas](https://cancergenome.nih.gov/abouttcga){target="_blank"} (TCGA) project ([related publication](https://www.nature.com/articles/ng.2764){target="_blank"})
...
exprTable( genes = genes, data = data, targets = targets, sampleName  = params$sample_name, normal  = ext_cancer_group, int_cancer = int_cancer_group, genes_annot = ref_datasets.list[[tissue]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], cancer_genes  = ref_genes.list[["genes_cancer"]][, c("Oncogene", "TSG", "Germline") ], fusion_genes = unique(known_translocations$geneA, known_translocations$geneB ), ext_links = TRUE, type = "z")[[1]]
```
