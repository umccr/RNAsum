...
ref_dataset <- list( "ext_ref" = c(paste0(params$ref_data_dir, "/ref_data/", strsplit(dataset, split='-', fixed=TRUE)[[1]][1], "_Counts.tsv.gz"), paste0(params$ref_data_dir, "/ref_data/", dataset, "_Target.txt"), paste0(strsplit(dataset, split='-', fixed=TRUE)[[1]][1], " (ICGC-AU)")),
                     "int_ref" = c(paste0(params$ref_data_dir, "/ref_data/UMCCR_PDAC_Counts.tsv.gz"), paste0(params$ref_data_dir, "/ref_data/UMCCR_PDAC_Target.txt"), "PAAD (UMCCR)")
)
