...
cdfPlot <- function(gene, data, targets, sampleName, int_cancer, ext_cancer, comp_cancer, addBoxPlot = FALSE, plot_mode = "static", scaling = "gene-wise") {
  ...
  if ( addBoxPlot ) {
    ...
    p2 <- plot_ly(gene.expr.df, x= ~Expression, color = ~Group, type = 'box', jitter = 0.3, pointpos = 0, boxpoints = 'all', colors = c("cornflowerblue", "red", "black"), opacity = 0.5, orientation = 'h', width = 800, height = plot_height, showlegend=FALSE)
  }
