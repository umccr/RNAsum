...
output:
  ...
  rmdformats::material:
    highlight: kate
params:
  sample_name: 'PRJ211057'
  dataset: 'PANCAN'
  bcbio_rnaseq: NULL
  dragen_rnaseq: '/Users/kanwals/UMCCR/data/wts/RNAsum/final/SBJ01010_PRJ211057_L2101524/dragen'
  arriba_rnaseq: '/Users/kanwals/UMCCR/data/wts/RNAsum/final/SBJ01010_PRJ211057_L2101524/dragen/arriba'
  ...
  drugs: FALSE
  immunogram: FALSE
  umccrise: '/Users/kanwals/UMCCR/data/wts/RNAsum/umccrised/SBJ01010__PRJ210838'
...
if ( !is.null(params$bcbio_rnaseq) ) {
  ...
  ##### Use salmon's gene quantification output
  if ( file.exists(paste0(dataDir, "/", list.files(dataDir, pattern=".quant.genes.sf$"))) ) {
...
if ( exists("counts_salmon") ){
  ref_dataset.list[[dataset]] <- combineDatasets(sample_name=sample_name, sample_counts=counts_salmon, ref_data=ref_dataset, report_dir = results_dir, dataset = dataset)
