...
if ( length(sampleID.col) > 0 ) {
  ...
  treamtents.reset <- as.Date("0000-01-01") - day0
...
NOTE: for confidentiality reasons, the timeline (*x-axis*) projecting patient's treatment regimens (*y-axis*) is set to start from January, but the treatments lengths are preserved.
