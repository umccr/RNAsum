...
mysql_populate <- paste0("### MySQL command to insert data for sample \"", params$sample_name, "\"\nINSERT INTO RNAseq_reports ( ID ,Platform, PatientID, SampleID, Tissue, Type, Project, URL, PMID, Analysis, Summary, Date ) VALUES ( 1000000, \"RNA_seq\",")
```
...
if ( runPcgrChunk ) {
  ...
  mysql_populate <- paste0(mysql_populate, params$sample_name, "\"\n")
