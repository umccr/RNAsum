...
5. **Pair counts** > 1 and **split counts** > 1
...
if ( runFusionChunk ) {
  ...
  fusions.table <- fusions.table[ , c("geneA", "geneB", "split_readsA", "split_readsB", "discordant_mates", "geneA_dna_support", "geneB_dna_support", "reported_fusion", "fusions_cancer", "reported_fusion_geneA", "reported_fusion_geneB", "confidence", "Arriba", "breakpointA", "breakpointB", "siteA", "siteB", "type")]
  names(fusions.table) <- c("Gene A", "Gene B", "Split reads (A)", "Split reads (B)", "Pair reads", "DNA support (A)", "DNA support (B)", "Reported fusion", "Cancer gene(s)", "Fusion gene (A)", "Fusion gene (B)", "Confidence (Arriba)", "Visualisation", "Breakpoint (A)", "Breakpoint (B)", "Site (A)", "Site (B)", "Type")
