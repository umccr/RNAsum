...
params:
  ...
  normal_group: 'Cervix uteri (normal)'
...
#### `r mut_genes.expr[[2]]$SYMBOL[428]`

```{r cdf_plot_mut_genes_428, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 3}
suppressMessages(library(plotly))
##### Generate empirical cumulative distribution function (ECDF) plot illustrating mRNA expression level the genes of interest in the context of the overall mRNA expression distribution
gene <- mut_genes.expr[[2]]$SYMBOL[428]
...
fuiosnExprProfile <- exprProfilePlot(c(as.vector(geneA), as.vector(geneB)), data, target, params$sample_name, params$normal_group, params$cancer_group, ref_datasets.list[[ref]][[5]])
...
```{r expr_plot_fusions_2, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 2.5}
suppressMessages(library(plotly))
##### Generate plots with genome-wide expression profile (Z-score) for each group
fuiosnExprProfile <- exprProfilePlot(c(as.vector(geneA), as.vector(geneB)), data, target, params$sample_name, params$normal_group, params$cancer_group, ref_datasets.list[[ref]][[5]])
...
```{r expr_plot_fusions_3, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 2.5}
suppressMessages(library(plotly))
##### Generate plots with genome-wide expression profile (Z-score) for each group
fuiosnExprProfile <- exprProfilePlot(c(as.vector(geneA), as.vector(geneB)), data, target, params$sample_name, params$normal_group, params$cancer_group, ref_datasets.list[[ref]][[5]])
...
```{r expr_plot_fusions_4, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 2.5}
suppressMessages(library(plotly))
##### Generate plots with genome-wide expression profile (Z-score) for each group
fuiosnExprProfile <- exprProfilePlot(c(as.vector(geneA), as.vector(geneB)), data, target, params$sample_name, params$normal_group, params$cancer_group, ref_datasets.list[[ref]][[5]])
