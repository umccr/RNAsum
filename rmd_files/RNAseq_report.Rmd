...
colnames(pizzly.fusions2)[-c(1:7)] <- c("Reported", "Effector_gene", "Cancer_acronym", "Source")
...
NOTE: currently, displaying the top hits from pizzly filtering output (<span style="color:#ff0000">red</span> and <span style="color:#0000ff">blue</span> sections in [Fusion events prioritisation] table.) Also, in the follwoing visualization section, the missing hits from the prioritized results are the ones for which no junctions are found by clinker.
...
NOTE: currently, fusion events involving highly abundant transcripts and cancer genes (<span style="color:#ff0000">red</span> and <span style="color:#0000ff">blue</span> sections in [Fusion events prioritisation] table) were screened for suitable drugs.
