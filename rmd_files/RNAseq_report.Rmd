...
cancer_genes.expr.percimmune_genes.expr.z <- exprTable( genes = unlist(ref_genes.list[["genes_immune"]]), data = data, targets = targets, sampleName = params$sample_name, normal = normal_group , cancer = cancer_group, genes_annot = ref_datasets.list[[tissue]][["gene_annot"]][, c(1,3)], type = "z")

##### Present the expression summary table
cancer_genes.expr.percimmune_genes.expr.z[[1]]
```
