...
**`r length(which(unique(unlist(ref_genes.list[["genes_hrd"]]$SYMBOL)) %in% rownames(ref_datasets.list[[dataset]][["batch_effect_corrected"]])))`** reliably measured [HRD genes] were screened for suitable drugs (see [HRD genes] section).
