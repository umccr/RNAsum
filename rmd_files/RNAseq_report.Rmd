...
params:
  ...
  genes_fusions: '../fusions/Genes_fusions.txt'
...
ref_genes.list[["genes_fusions"]] <- read.table(params$genes_fusions, sep="\t", as.is=TRUE, header=FALSE, row.names=NULL, quote="")
...
pizzly.fusions <- read.table(file = paste(dataDir, "pizzly/pizzly-flat-filtered.tsv", sep = "/"), header = TRUE)
quant <- read.table(file = paste(dataDir, "kallisto/abundance.tsv", sep = "/"), header = TRUE)
