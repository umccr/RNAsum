...
# 8. ref_datasets.list[[dataset]][["data_to_report"]] = Fully combined and processed data to be used for reporting

# 9. ref_datasets.list[[dataset]][["gene_annot_all"]] = gene annotation for combined read count data, containing all input genes. The annotation includes "SYMBOL", "GENEBIOTYPE", "ENSEMBL", "SEQNAME", "GENESEQSTART", "GENESEQEND". "ENSEMBL" is used for rownames

# 10. ref_datasets.list[[dataset]][["gene_annot"]] = gene annotation for transformed, filtered and normalised data. The annotation includes "SYMBOL", "GENEBIOTYPE", "ENSEMBL", "SEQNAME", "GENESEQSTART", "GENESEQEND". "SYMBOL" is used for rownames

# 11. ref_datasets.list[[dataset]][["expr_mut_cn_data"]] = combined expression, mutation and copy-number data
...
mutCNexprPlot <- function(data, alt_data = FALSE, cn_bottom = 1.5, cn_top = 3, comp_cancer, type = "z", plot_mode = "static") {
...
ref_dataset <- list( "paad" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_PAAD.txt", sep="/"), "PAAD (UMCCR)", "PAAD (TCGA)"), 
                     "cesc" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_CESC.txt", sep="/"), "PAAD (UMCCR)", "CESC (TCGA)"), 
                     "blca" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_BLCA.txt", sep="/"), "PAAD (UMCCR)", "BLCA (TCGA)"),
                     "brca" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_BRCA.txt", sep="/"), "PAAD (UMCCR)", "BRCA (TCGA)"),
                     "thca" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_THCA.txt", sep="/"), "PAAD (UMCCR)", "THCA (TCGA)"),
                     "hnsc" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_HNSC.txt", sep="/"), "PAAD (UMCCR)", "HNSC (TCGA)"),
                     "lgg" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_LGG.txt", sep="/"), "PAAD (UMCCR)", "LGG (TCGA)"),
                     "kirc" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_KIRC.txt", sep="/"), "PAAD (UMCCR)", "KIRC (TCGA)"),
                     "lusc" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_LUSC.txt", sep="/"), "PAAD (UMCCR)", "LUSC (TCGA)"),
                     "luad" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_LUAD.txt", sep="/"), "PAAD (UMCCR)", "LUAD (TCGA)"),
                     "prad" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_PRAD.txt", sep="/"), "PAAD (UMCCR)", "PRAD (TCGA)"),
                     "skcm" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_SKCM.txt", sep="/"), "PAAD (UMCCR)", "SKCM (TCGA)"),
                     "stad" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_STAD.txt", sep="/"), "PAAD (UMCCR)", "STAD (TCGA)"),
                     "lihc" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_LIHC.txt", sep="/"), "PAAD (UMCCR)", "LIHC (TCGA)"),
                     "coad" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_COAD.txt", sep="/"), "PAAD (UMCCR)", "COAD (TCGA)"),
                     "kirp" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_KIRP.txt", sep="/"), "PAAD (UMCCR)", "KIRP (TCGA)"),
                     "ov" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_OV.txt", sep="/"), "PAAD (UMCCR)", "OV (TCGA)"),
                     "sarc" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_SARC.txt", sep="/"), "PAAD (UMCCR)", "SARC (TCGA)"),
                     "pcpg" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_PCPG.txt", sep="/"), "PAAD (UMCCR)", "PCPG (TCGA)"),
                     "ucec" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_UCEC.txt", sep="/"), "PAAD (UMCCR)", "UCEC (TCGA)"),
                     "laml" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_LAML.txt", sep="/"), "PAAD (UMCCR)", "LAML (TCGA)"),
                     "esca" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_ESCA.txt", sep="/"), "PAAD (UMCCR)", "ESCA (TCGA)"),
                     "gbm" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_GBM.txt", sep="/"), "PAAD (UMCCR)", "GBM (TCGA)"),
                     "tgct" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_TGCT.txt", sep="/"), "PAAD (UMCCR)", "TGCT (TCGA)"),
                     "thym" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_THYM.txt", sep="/"), "PAAD (UMCCR)", "THYM (TCGA)"),
                     "read" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_READ.txt", sep="/"), "PAAD (UMCCR)", "READ (TCGA)"),
                     "kich" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_KICH.txt", sep="/"), "PAAD (UMCCR)", "KICH (TCGA)"),
                     "uvm" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_UVM.txt", sep="/"), "PAAD (UMCCR)", "UVM (TCGA)"),
                     "meso" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_MESO.txt", sep="/"), "PAAD (UMCCR)", "MESO (TCGA)"),
                     "acc" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_ACC.txt", sep="/"), "PAAD (UMCCR)", "ACC (TCGA)"),
                     "ucs" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_UCS.txt", sep="/"), "PAAD (UMCCR)", "UCS (TCGA)"),
                     "dlbc" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_DLBC.txt", sep="/"), "PAAD (UMCCR)", "DLBC (TCGA)"),
                     "chol" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_CHOL.txt", sep="/"), "PAAD (UMCCR)", "CHOL (TCGA)"),
                     "blca-net" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_BLCA-NET.txt", sep="/"), "PAAD (UMCCR)", "BLCA (TCGA)", "BLCA-NET (TCGA)"),
                     "paad-ipmn" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_PAAD-IPMN.txt", sep="/"), "PAAD (UMCCR)", "PAAD (TCGA)", "PAAD-IPMN (TCGA)"),
                     "paad-net" = c(paste(params$ref_data_dir, "ref_datasets/Datasets_list_PAAD-NET.txt", sep="/"), "PAAD (UMCCR)", "PAAD (TCGA)", "PAAD-NET (TCGA)")
)
...
if ( length(ref_dataset[[dataset]]) > 3 ) {
  
  add_cancer_group <- ref_dataset[[dataset]][4]
} else {
...
if ( runPurpleChunk ) {
  ...
  ref_genes.list[["summary"]]$CN <- unique(ref_genes.list[["summary"]]$CN[ ref_genes.list[["summary"]]$CN$MinCopyNumber < params$cn_loss | ref_genes.list[["summary"]]$CN$MaxCopyNumber > params$cn_gain, ]$Gene)
}
...
cpm.min <- round(min(as.numeric(colSums(ref_datasets.list[[dataset]][["combined_data"]])*1e-6)), digits=0)
cpm.max <- round(max(as.numeric(colSums(ref_datasets.list[[dataset]][["combined_data"]])*1e-6)), digits=0)
...
if ( params$filter ) {
  ...
  if ( params$log ) {
    ...
    data.df <- as.data.frame(cbind( exp(y[["comb"]]$transformed[,ncol(y[["comb"]]$transformed)]), ref_datasets.list[[dataset]][["combined_data"]][,ncol(ref_datasets.list[[dataset]][["combined_data"]])]))
    ...
    data.df$Transformed <- log(data.df$Transformed)
     ...
     data.df <- as.data.frame(cbind( y[["comb"]]$transformed[,ncol(y[["comb"]]$transformed)], ref_datasets.list[[dataset]][["combined_data"]][,ncol(ref_datasets.list[[dataset]][["combined_data"]])]))
    names(data.df) <- c("Transformed", "Counts")
  }
...
if ( tolower(params$norm) != "none" ) {
  ...
  ref_datasets.list[[dataset]][["combined_data_processed"]] <- y[["comb"]]$noNorm
}
...
batches <- as.character(ref_datasets.list[[dataset]][["sample_annot"]]$Dataset)
...
for ( dataset in names(ref_datasets.list) ) {
  ...
  if ( params$batch_rm ) {
    ...
    ref_datasets.list[[dataset]][["pca_combined_data_processed"]] <- pca(ref_datasets.list[[dataset]][["combined_data_processed"]], target, title = "Before batch-effects correction", plot_mode = params$plots_mode)
    
    ref_datasets.list[[dataset]][["pca_batch_effect_corrected"]] <- pca(ref_datasets.list[[dataset]][["batch_effect_corrected"]], target, title = "After batch-effects correction",  plot_mode = params$plots_mode)
    
    ref_datasets.list[[dataset]][["data_to_report"]] <- ref_datasets.list[[dataset]][["batch_effect_corrected"]]
    ...
    ref_datasets.list[[dataset]][["data_to_report"]] <- ref_datasets.list[[dataset]][["combined_data_processed"]]
  }
}
##### Detach plotly package. Otherwise it clashes with other graphics devices
detach("package:plotly", unload=FALSE)
...
for ( dataset in names(ref_datasets.list) ) {
  ...
  ##### Convert data into a data frame to make the Ensembl ID and gene symbol matches (with merge function)
  data <- ref_datasets.list[[dataset]][["data_to_report"]]
  data.df <- as.data.frame(cbind(rownames(data), data))
  colnames(data.df)[1] <- "ENSEMBL"
  ...
  ##### Get data matrix with gene symbols
  ref_datasets.list[[dataset]][["data_to_report"]] <- apply(data.annot[, colnames(data)], 2, as.numeric)
  rownames(ref_datasets.list[[dataset]][["data_to_report"]]) <- data.annot$SYMBOL
  ...
  write.table(prepare2write(ref_datasets.list[[dataset]][["data_to_report"]]), file = paste0(params$report_dir, "/", params$sample_name, ".", params$dataset, ".combined_data_processed.txt"), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE, append = FALSE )
  write.table(prepare2write(rownames(ref_datasets.list[[dataset]][["data_to_report"]])), file = paste0(params$report_dir, "/", params$sample_name, ".", params$dataset,  ".combined_data_processed.genes.txt"), sep="\t", quote=FALSE, row.names=FALSE, col.names=TRUE, append = FALSE )
...
if ( params$plots_mode == "interactive" || params$plots_mode == "semi-interactive" ) {
  ...
  genes.expr.z <- exprTable( genes = rownames(data), data = data, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], oncokb_annot = ref_genes.list[["genes_oncokb"]], cancer_genes = ref_genes.list[["genes_cancer"]], ext_links = TRUE, type = "z", scaling = scaling)
  
  genes.expr.perc <- exprTable( genes = rownames(data), data = data, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], oncokb_annot = ref_genes.list[["genes_oncokb"]], cancer_genes = ref_genes.list[["genes_cancer"]], ext_links = TRUE, type = "perc", scaling = scaling)
...
expr_data <- ref_datasets.list[[dataset]][["data_to_report"]]
targets <- ref_datasets.list[[dataset]][["sample_annot"]]
...
if ( !is.null(ref_genes.list[["pcgr"]]) ) {
  ...
  ##### Prepare data frame
  ref_datasets.list[[dataset]][["expr_mut_cn_data"]] <- data.frame(names(expr_data.z.sub), cn_data.sub$MeanCopyNumber, expr_data.z.sub, expr_data.perc.sub, gene.mut.sub)
  colnames(ref_datasets.list[[dataset]][["expr_mut_cn_data"]]) <- c("Gene", "CN", "Z_score_diff", "Perc_diff", "Alteration")
  ...
  ##### Prepare data frame
  ref_datasets.list[[dataset]][["expr_mut_cn_data"]] <- data.frame(names(expr_data.z.sub), cn_data.sub$MeanCopyNumber, expr_data.z.sub, expr_data.perc.sub)
  colnames(ref_datasets.list[[dataset]][["expr_mut_cn_data"]]) <- c("Gene", "CN", "Z_score_diff", "Perc_diff")
}
```
...
if ( runPurpleChunk ) {
  ...
  #### Keep only genes with CN values > 3 or < 0.5 are annotated
  ref_genes.list[["summary"]]$CN <- ref_datasets.list[[dataset]][["expr_mut_cn_data"]]
  ref_genes.list[["summary"]]$CN <- as.character(ref_genes.list[["summary"]]$CN[ ref_genes.list[["summary"]]$CN$CN < 0.5 | ref_genes.list[["summary"]]$CN$CN > 3,  ]$Gene)
}
```
...
* `r if (params$filter) { nrow(ref_datasets.list[[dataset]][["combined_data"]]) - nrow(ref_datasets.list[[dataset]][["data_to_report"]]) } else { ("0") }` are either not expressed or their expression level is too low to be detected
* `r if (params$filter) { nrow(ref_datasets.list[[dataset]][["data_to_report"]]) - nrow(data.annot) } else { nrow(ref_datasets.list[[dataset]][["combined_data"]]) - nrow(data.annot) }` genes were ignored due to lack of [HGNC](https://www.genenames.org/){target="_blank"}-approved gene symbol

NOTE: the `r if (params$filter) { nrow(ref_datasets.list[[dataset]][["combined_data"]]) - nrow(ref_datasets.list[[dataset]][["data_to_report"]]) } else { ("0") }` genes with no/low expression are indicated in <span style="color:#808080">BLANK</span> cells with missing values in *expression summary tables* in [Mutated genes], [Cancer genes], [Structural variants], [CN altered genes] and [Immune markers] sections.
...
mut_genes.expr.z <- exprTable( genes = genes, data = data, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], mut_annot = ref_genes.list[["pcgr"]][, c("SYMBOL", "TIER", "CONSEQUENCE", "VARIANT_CLASS", "AF_TUMOR", "GENOMIC_CHANGE", "PROTEIN_CHANGE")], oncokb_annot = ref_genes.list[["genes_oncokb"]], cancer_genes = ref_genes.list[["genes_cancer"]][, c("Oncogene", "TSG", "Fusion", "Germline") ], ext_links = TRUE, type = "z", scaling = scaling)
...
mut_genes.expr.perc <- exprTable( genes = genes, data = data, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], mut_annot = ref_genes.list[["pcgr"]][, c("SYMBOL", "TIER", "CONSEQUENCE", "VARIANT_CLASS", "AF_TUMOR", "GENOMIC_CHANGE", "PROTEIN_CHANGE")], oncokb_annot = ref_genes.list[["genes_oncokb"]], cancer_genes = ref_genes.list[["genes_cancer"]][, c("Oncogene", "TSG", "Fusion", "Germline") ], ext_links = TRUE, type = "perc", scaling = scaling)
...
exprTable( genes = genes, data = data, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], oncokb_annot = ref_genes.list[["genes_oncokb"]], cancer_genes = ref_genes.list[["genes_cancer"]][, c("Oncogene", "TSG", "Germline") ], fusion_genes = unique(known_translocations$geneA, known_translocations$geneB ), ext_links = TRUE, type = "z", scaling = scaling)[[1]]
```
...
Out of the `r if ( runSVsChunk ) { length(unique(manta_sv$Gene)) } ` genes affected by `r if ( runSVsChunk ) { nrow(manta_sv) }` SVs, the expression of **`r if ( runSVsChunk ) { length(which(unique(manta_sv$Gene) %in% rownames(ref_datasets.list[[dataset]][["data_to_report"]]))) }`** was reliably measured in patient's sample. The remaining `r if ( runSVsChunk ) { length(which(unique(manta_sv$Gene) %!in% rownames(ref_datasets.list[[dataset]][["data_to_report"]]))) }` genes are either not expressed or their expression level is too low to be detected (indicated in <span style="color:#808080">BLANK</span> cells with missing values).
...
sv_genes.expr.z <- exprTable( genes = genes, data = data, sv_data = manta_sv, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], cancer_genes = ref_genes.list[["genes_cancer"]][, c("Oncogene", "TSG", "Fusion", "Germline") ], oncokb_annot = ref_genes.list[["genes_oncokb"]], ext_links = TRUE, type = "z", scaling = scaling)
...
##### Generate expression summary table for cancer genes from OncoKB and PMCC
sv_genes.expr.perc <- exprTable( genes = genes, data = data, sv_data = manta_sv, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], oncokb_annot = ref_genes.list[["genes_oncokb"]], cancer_genes = ref_genes.list[["genes_cancer"]][, c("Oncogene", "TSG", "Fusion", "Germline") ], ext_links = TRUE, type = "perc", scaling = scaling)
...
Scatterplot comparing the per-gene difference in **mRNA expression** between patient's sample and cancer individuals (*y-axis*), **CN values** (*x-axis*, from [PURPLE](https://anaconda.org/bioconda/hmftools-purple){target="_blank"}). If the mutation status information is available then the genes's colours correspond to the variant(s) consequence (from [PCGR](https://github.com/sigven/pcgr){target="_blank"}). Genes with CN values > 3 or < 0.5 are annotated.
...
if ( runPcgrChunk && length(cn_genes) > 0 ) {
  ...
  mutCNexprPlot(data = data, alt_data = TRUE, cn_bottom = 0.5, cn_top = 3, comp_cancer = comp_cancer_group, type = "z", plot_mode = params$plots_mode)
  
} else if ( length(cn_genes) > 0) {
  
  data <- data[ data$Gene %in% cn_genes, ]
  mutCNexprPlot(data = data, alt_data = FALSE, cn_bottom = 0.5, cn_top = 3, comp_cancer = comp_cancer_group, type = "z", plot_mode = params$plots_mode)
...
if ( runPcgrChunk && length(cn_genes) > 0 ) {
  ...
  mutCNexprPlot(data = data, alt_data = TRUE, cn_bottom = 0.5, cn_top = 3, comp_cancer = comp_cancer_group, type = "perc", plot_mode = params$plots_mode)
  
} else if ( length(cn_genes) > 0) {
  
  data <- data[ data$Gene %in% cn_genes, ]
  mutCNexprPlot(data = data, alt_data = FALSE, cn_bottom = 0.5, cn_top = 3, comp_cancer = comp_cancer_group, type = "perc", plot_mode = params$plots_mode)
...
Out of the `r length(ref_datasets.list[[dataset]][["expr_mut_cn_data"]][,1])` genes within gained (CN values > `r params$cn_gain`) or lossed (CN values < `r params$cn_loss`) regions `r if (runPurpleChunk) { length(cn_genes) } else { length(NULL) }` are either [Cancer genes], [Mutated genes] with [tier](https://pcgr.readthedocs.io/en/latest/tier_systems.html#tier-model-2-pcgr-acmg){target="_blank"} 1-`r params$pcgr_tier` variants (if mutation information is available) or are involved in [Fusion genes] or [Structural variants] (if SV information is available). The expression of **`r if (runPurpleChunk) { length(which(cn_genes %in% rownames(ref_datasets.list[[dataset]][["data_to_report"]]))) } else { length(NULL) }`** of these genes was reliably measured in patient's sample. The remaining `r if (runPurpleChunk) { length(which(cn_genes %!in% rownames(ref_datasets.list[[dataset]][["data_to_report"]]))) } else { length(NULL) }` genes are either not expressed or their expression level is too low to be detected (indicated in <span style="color:#808080">BLANK</span> cells with missing values).
...
if ( runPcgrChunk && runPurpleChunk ) {
  ...
  mut_cn_expr_genes.expr.gains.z <- exprTable( genes = genes, data = data, cn_data = cn_data, cn_decrease = TRUE, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], mut_annot = ref_genes.list[["pcgr"]][, c("SYMBOL", "TIER", "CONSEQUENCE", "VARIANT_CLASS", "AF_TUMOR", "GENOMIC_CHANGE", "PROTEIN_CHANGE")], oncokb_annot = ref_genes.list[["genes_oncokb"]], cancer_genes = ref_genes.list[["genes_cancer"]][, c("Oncogene", "TSG", "Fusion", "Germline") ], ext_links = TRUE, type = "z", scaling = scaling)
  
##### Generate expression summary table for per-gene expression values and CN values
} else if ( runPurpleChunk ) {
    
  mut_cn_expr_genes.expr.gains.z <- exprTable( genes = genes, data = data, cn_data = cn_data, cn_decrease = TRUE, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], cancer_genes = ref_genes.list[["genes_cancer"]][, c("Oncogene", "TSG", "Fusion", "Germline") ], ext_links = TRUE, type = "z", scaling = scaling)
}
...
if ( runPcgrChunk && runPurpleChunk ) {
  ...
  mut_cn_expr_genes.expr.gains.perc <- exprTable( genes = genes, data = data, cn_data = cn_data, cn_decrease = TRUE, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], mut_annot = ref_genes.list[["pcgr"]][, c("SYMBOL", "TIER", "CONSEQUENCE", "VARIANT_CLASS", "AF_TUMOR", "GENOMIC_CHANGE", "PROTEIN_CHANGE")], oncokb_annot = ref_genes.list[["genes_oncokb"]], cancer_genes = ref_genes.list[["genes_cancer"]][, c("Oncogene", "TSG", "Fusion", "Germline") ], ext_links = TRUE, type = "perc", scaling = scaling)
  
##### Generate expression summary table for per-gene expression values and CN values
} else if ( runPurpleChunk ) {
  
  mut_cn_expr_genes.expr.gains.perc <- exprTable( genes = genes, data = data, cn_data = cn_data, cn_decrease = TRUE, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], oncokb_annot = ref_genes.list[["genes_oncokb"]], cancer_genes = ref_genes.list[["genes_cancer"]][, c("Oncogene", "TSG", "Fusion", "Germline") ], ext_links = TRUE, type = "perc", scaling = scaling)
}
...
if ( runPcgrChunk && runPurpleChunk ) {
  ...
  mut_cn_expr_genes.expr.losses.z <- exprTable( genes = genes, data = data, cn_data = cn_data, cn_decrease = FALSE, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], mut_annot = ref_genes.list[["pcgr"]][, c("SYMBOL", "TIER", "CONSEQUENCE", "VARIANT_CLASS", "AF_TUMOR", "GENOMIC_CHANGE", "PROTEIN_CHANGE")], oncokb_annot = ref_genes.list[["genes_oncokb"]], cancer_genes = ref_genes.list[["genes_cancer"]][, c("Oncogene", "TSG", "Fusion", "Germline") ], ext_links = TRUE, type = "z", scaling = scaling)
  
##### Generate expression summary table for per-gene expression values and CN values
} else if ( runPurpleChunk ) {
    
  mut_cn_expr_genes.expr.losses.z <- exprTable( genes = genes, data = data, cn_data = cn_data, cn_decrease = FALSE, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], oncokb_annot = ref_genes.list[["genes_oncokb"]], cancer_genes = ref_genes.list[["genes_cancer"]][, c("Oncogene", "TSG", "Fusion", "Germline") ], ext_links = TRUE, type = "z", scaling = scaling)
}
...
if ( runPcgrChunk && runPurpleChunk ) {
  ...
  mut_cn_expr_genes.expr.losses.perc <- exprTable( genes = genes, data = data, cn_data = cn_data, cn_decrease = FALSE, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], mut_annot = ref_genes.list[["pcgr"]][, c("SYMBOL", "TIER", "CONSEQUENCE", "VARIANT_CLASS", "AF_TUMOR", "GENOMIC_CHANGE", "PROTEIN_CHANGE")], oncokb_annot = ref_genes.list[["genes_oncokb"]], cancer_genes = ref_genes.list[["genes_cancer"]][, c("Oncogene", "TSG", "Fusion", "Germline") ], ext_links = TRUE, type = "perc", scaling = scaling)
  
##### Generate expression summary table for per-gene expression values and CN values
} else if ( runPurpleChunk ) {
  
  mut_cn_expr_genes.expr.losses.perc <- exprTable( genes = genes, data = data, cn_data = cn_data, cn_decrease = FALSE, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], oncokb_annot = ref_genes.list[["genes_oncokb"]], cancer_genes = ref_genes.list[["genes_cancer"]][, c("Oncogene", "TSG", "Fusion", "Germline") ], ext_links = TRUE, type = "perc", scaling = scaling)
}
...
Out of the `r length(unique(unlist(ref_genes.list[["genes_immune"]]$SYMBOL)))` immune markers the expression of **`r length(which(unique(unlist(ref_genes.list[["genes_immune"]]$SYMBOL)) %in% rownames(ref_datasets.list[[dataset]][["data_to_report"]])))`** was reliably measured in patient's sample. The remaining `r length(which(unique(unlist(ref_genes.list[["genes_immune"]]$SYMBOL)) %!in% rownames(ref_datasets.list[[dataset]][["data_to_report"]])))` genes are either not expressed or their expression level is too low to be detected (indicated in <span style="color:#808080">BLANK</span> cells with missing values).
...
immune_genes.expr.z <- exprTable( genes = genes, data = data, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL", "Immune_Cycle_Role")], oncokb_annot = ref_genes.list[["genes_oncokb"]], ext_links = TRUE, type = "z", scaling = scaling)
...
##### Generate expression summary table for cancer genes from OncoKB and PMCC
immune_genes.expr.perc <- exprTable( genes = genes, data = data, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL", "Immune_Cycle_Role")], oncokb_annot = ref_genes.list[["genes_oncokb"]], ext_links = TRUE, type = "perc", scaling = scaling)
...
Out of the `r length(unique(unlist(ref_genes.list[["genes_hrd"]]$SYMBOL)))` hrd genes the expression of **`r length(which(unique(unlist(ref_genes.list[["genes_hrd"]]$SYMBOL)) %in% rownames(ref_datasets.list[[dataset]][["data_to_report"]])))`** was reliably measured in patient's sample. The remaining `r length(which(unique(unlist(ref_genes.list[["genes_hrd"]]$SYMBOL)) %!in% rownames(ref_datasets.list[[dataset]][["data_to_report"]])))` genes are either not expressed or their expression level is too low to be detected (indicated in <span style="color:#808080">BLANK</span> cells with missing values).
...
hrd_genes.expr.z <- exprTable( genes = genes, data = data, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], oncokb_annot = ref_genes.list[["genes_oncokb"]], ext_links = TRUE, type = "z", scaling = scaling)
...
hrd_genes.expr.perc <- exprTable( genes = genes, data = data, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], oncokb_annot = ref_genes.list[["genes_oncokb"]], ext_links = TRUE, type = "perc", scaling = scaling)
...
Out of the `r nrow(ref_genes.list[["genes_cancer"]])` cancer genes the expression of **`r length(which(rownames(ref_genes.list[["genes_cancer"]]) %in% rownames(ref_datasets.list[[dataset]][["data_to_report"]])))`** was reliably measured in patient's sample. The remaining `r length(which(rownames(ref_genes.list[["genes_cancer"]]) %!in% rownames(ref_datasets.list[[dataset]][["data_to_report"]])))` genes are either not expressed or their expression level is too low to be detected (indicated in <span style="color:#808080">BLANK</span> cells with missing values).
...
cancer_genes.expr.z <- exprTable( genes = rownames(ref_genes.list[["genes_cancer"]]), data = data, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], oncokb_annot = ref_genes.list[["genes_oncokb"]], cancer_genes = ref_genes.list[["genes_cancer"]], ext_links = TRUE, type = "z", scaling = scaling)
...
cancer_genes.expr.perc <- exprTable( genes = rownames(ref_genes.list[["genes_cancer"]]), data = data, targets = targets, sampleName = params$sample_name, ext_cancer = ext_cancer_group, int_cancer = int_cancer_group, comp_cancer = comp_cancer_group, add_cancer = add_cancer_group, genes_annot = ref_datasets.list[[dataset]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], oncokb_annot = ref_genes.list[["genes_oncokb"]], cancer_genes = ref_genes.list[["genes_cancer"]], ext_links = TRUE, type = "perc", scaling = scaling)
...
**`r length(which(unique(unlist(ref_genes.list[["genes_hrd"]]$SYMBOL)) %in% rownames(ref_datasets.list[[dataset]][["data_to_report"]])))`** reliably measured [HRD genes] were screened for suitable drugs (see [HRD genes] section).
