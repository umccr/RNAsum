...
params:
  ...
  dataset: 'PAAD'
  bcbio_rnaseq: NULL
  dragen_rnaseq: '/Users/kanwals/UMCCR/data/wts/RNAsum/final/SBJ00238_MDX190231_L1901028/dragen'
  arriba_rnaseq: '/Users/kanwals/UMCCR/data/wts/RNAsum/final/SBJ00238_MDX190231_L1901028/dragen/arriba'
  report_dir: '/Users/kanwals/UMCCR/data/wts/RNAsum/reports/SBJ00238_MDX190231_L1901028'
  ref_data_dir: '../data'
  transform: 'CPM'
  filter: TRUE
  norm: 'TMM'
  ...
  drugs: FALSE
  immunogram: FALSE
  umccrise: '/Users/kanwals/UMCCR/data/wts/RNAsum/umccrised/SBJ00238__SBJ00238_MDX190230_L1901041'
...
dragen_mapping_metrics <- paste(params$dragen_rnaseq, list.files(params$dragen_rnaseq, pattern="\\.mapping_metrics.csv$"), sep = "/")
if ( file.exists(dragen_mapping_metrics) ) {
...
Transcriptome summary for patient sample **`r if ( file.exists(dragen_mapping_metrics) ) {paste0(params$sample_name, params$dataset_name_incl, ", Library size ",total_input_reads_millions)} else {paste0(params$sample_name, params$dataset_name_incl)}`**.
