...
<span style="color:#ff0000">NOTE</span>: `r if ( runFusionChunk ) { nrow(fusions[ (fusions$geneA_dna_support == "Yes" | fusions$geneB_dna_support == "Yes" | fusions$geneA_dna_support == "Yes") & fusions$circos != "Yes", ]) } else { c("0") }` of such fusions do not have genomic information available (see *Genomic view* column in the [Summary] table). 
