...
sv_genes.expr.z <- exprTable( genes = genes, data = data, targets = targets, sampleName = params$sample_name, normal = normal_group , cancer = cancer_group, genes_annot = ref_datasets.list[[tissue]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], OncoKB_genes = ref_genes.list[["oncokb_genes"]][,c("Oncogene", "TSG", "OncoKB")], fusion_genes = fusion_annot_reported, ext_links = TRUE, type = "z")
...
##### Generate expression summary table for cancer genes from OncoKB and PMCC
sv_genes.expr.perc <- exprTable( genes = genes, data = data, targets = targets, sampleName = params$sample_name, normal = normal_group , cancer = cancer_group, genes_annot = ref_datasets.list[[tissue]][["gene_annot_all"]][, c("SYMBOL", "ENSEMBL")], OncoKB_genes = ref_genes.list[["oncokb_genes"]][,c("Oncogene", "TSG", "OncoKB")], fusion_genes = fusion_annot_reported, ext_links = TRUE, type = "perc")
...
#### `r if ( runSVsChunk) { sv_genes.expr.z[[2]]$SYMBOL[1] }`
...
#### `r if ( runSVsChunk) { sv_genes.expr.z[[2]]$SYMBOL[2] }`
...
#### `r if ( runSVsChunk) { sv_genes.expr.z[[2]]$SYMBOL[3] }`
...
#### `r if ( runSVsChunk) { sv_genes.expr.z[[2]]$SYMBOL[4] }`
...
#### `r if ( runSVsChunk) { sv_genes.expr.z[[2]]$SYMBOL[5] }`
...
#### `r if ( runSVsChunk) { sv_genes.expr.z[[2]]$SYMBOL[6] }`
...
#### `r if ( runSVsChunk) { sv_genes.expr.z[[2]]$SYMBOL[7] }`
...
#### `r if ( runSVsChunk) { sv_genes.expr.z[[2]]$SYMBOL[8] }`
...
#### `r if ( runSVsChunk) { sv_genes.expr.z[[2]]$SYMBOL[9] }`
...
#### `r if ( runSVsChunk) { sv_genes.expr.z[[2]]$SYMBOL[10] }`
