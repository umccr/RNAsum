...
cdfPlot <- function(gene, data, targets, sampleName, normal, cancer, addBoxPlot = FALSE, plot_mode = "static") {
  ...
  layout(xaxis = list(title = "mRNA expression (Z-score)", zeroline = FALSE, range = c(min(sample.expr.cum$z)-1.5, max(sample.expr.cum$z)+1.5)),
    ...
    if ( plot_mode == "static" ) {
      ...
      orca(p1, format = "png", file = paste0(gene, "_cdf_plot.png"), width = 800, height = 600)
...
cdfPlot(gene, data, target, params$sample_name, normal_group, cancer_group, addBoxPlot = TRUE, plot_mode = params$plots_mode)
...
cdfPlot(geneA, data, target, params$sample_name, normal_group, cancer_group, plot_mode = params$plots_mode)
cdfPlot(geneB, data, target, params$sample_name, normal_group, cancer_group, plot_mode = params$plots_mode)
