...
pizzly.fusions <- rbind(deduped.sorted.result, result.sorted.cancer_genes, result.sorted.other_genes)
...
if ( !is.na(gene) && gene %in% rownames(data) ) {
  ...
  if ( is.na(gene) ) {
    cat(paste("There are", length(mut_genes.expr.z[[2]]$SYMBOL), "mutated genes that include tier 1-3 variantsd!", sep=" "))
...
#### `r paste(pizzly.fusions$geneA.name[1], pizzly.fusions$geneB.name[1], sep="-")`
...
#### `r paste(pizzly.fusions$geneA.name[2], pizzly.fusions$geneB.name[2], sep="-")`
...
#### `r paste(pizzly.fusions$geneA.name[3], pizzly.fusions$geneB.name[3], sep="-")`
...
#### `r paste(pizzly.fusions$geneA.name[4], pizzly.fusions$geneB.name[4], sep="-")`
...
#### `r paste(pizzly.fusions$geneA.name[5], pizzly.fusions$geneB.name[5], sep="-")`
