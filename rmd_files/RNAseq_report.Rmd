...
NOTE: currently, displaying the drugs targeting the top 6 cancer genes with the greatest difference in standarised (Z-score) mRNA expression values between patient's sample and the average mRNA expression in samples from normal individuals (see [Cancer genes expression profiles] section).

#### `r cancer_genes.expr[[2]]$SYMBOL[1]`

```{r drugs_cancer_genes_1, comment = NA, message=FALSE, warning=FALSE}
...
civicDrugTable(gene, caner_genes_annot.list[["civic_gene_summaries"]], caner_genes_annot.list[["civic_var_summaries"]], caner_genes_annot.list[["civic_clin_evid"]], caner_genes_annot.list[["civic_variant_group"]])[[1]]
```
...
```{r drugs_cancer_genes_2, comment = NA, message=FALSE, warning=FALSE}
##### Generate table with drugs targeting dysregulated cancer genes
ref <- params$tissue
target <- ref_datasets.list[[ref]][[2]]
data <- ref_datasets.list[[ref]][[3]]
...
```{r drugs_cancer_genes_3, comment = NA, message=FALSE, warning=FALSE}
##### Generate table with drugs targeting dysregulated cancer genes
ref <- params$tissue
target <- ref_datasets.list[[ref]][[2]]
data <- ref_datasets.list[[ref]][[3]]
...
```{r drugs_cancer_genes_4, comment = NA, message=FALSE, warning=FALSE}
##### Generate table with drugs targeting dysregulated cancer genes
ref <- params$tissue
target <- ref_datasets.list[[ref]][[2]]
data <- ref_datasets.list[[ref]][[3]]
...
```{r drugs_cancer_genes_5, comment = NA, message=FALSE, warning=FALSE}
##### Generate table with drugs targeting dysregulated cancer genes
ref <- params$tissue
target <- ref_datasets.list[[ref]][[2]]
data <- ref_datasets.list[[ref]][[3]]
...
```{r drugs_cancer_genes_6, comment = NA, message=FALSE, warning=FALSE}
##### Generate table with drugs targeting dysregulated cancer genes
ref <- params$tissue
target <- ref_datasets.list[[ref]][[2]]
data <- ref_datasets.list[[ref]][[3]]
...
```{r drugs_fusion_genes_2, comment = NA, message=FALSE, warning=FALSE}
##### Generate table with drugs targeting dysregulated cancer genes
ref <- params$tissue
target <- ref_datasets.list[[ref]][[2]]
data <- ref_datasets.list[[ref]][[3]]
...
civicDrugTable(c(levels(geneA)[geneA], levels(geneB)[geneB]), caner_genes_annot.list[["civic_gene_summaries"]], caner_genes_annot.list[["civic_var_summaries"]], caner_genes_annot.list[["civic_clin_evid"]], caner_genes_annot.list[["civic_variant_group"]])[[1]]
```
...
```{r drugs_fusion_genes_3, comment = NA, message=FALSE, warning=FALSE}
##### Generate table with drugs targeting dysregulated cancer genes
ref <- params$tissue
target <- ref_datasets.list[[ref]][[2]]
data <- ref_datasets.list[[ref]][[3]]
...
```{r drugs_fusion_genes_4, comment = NA, message=FALSE, warning=FALSE}
##### Generate table with drugs targeting dysregulated cancer genes
ref <- params$tissue
target <- ref_datasets.list[[ref]][[2]]
data <- ref_datasets.list[[ref]][[3]]
