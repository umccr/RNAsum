...
```{r pca_plot_combined_data, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 8 }
ref_datasets.list[[dataset]][["pca_combined_data_processed"]][[2]]
```

- After batch-effects correction

```{r pca_plot_batch_effect_corrected, comment = NA, message=FALSE, warning=FALSE, fig.width = 8, fig.height = 8 }
...
```{r scree_plot_combined_data, comment = NA, message=FALSE, warning=FALSE, fig.width = 12, fig.height = 5 }
ref_datasets.list[[dataset]][["pca_combined_data_processed"]][[3]]
```

- Before batch-effects correction

```{r scree_plot_batch_effect_corrected, comment = NA, message=FALSE, warning=FALSE, fig.width = 12, fig.height = 5 }
