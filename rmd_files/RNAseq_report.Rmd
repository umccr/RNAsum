...
pizzly.fusions <- pizzly.fusions[ order(pizzly.fusions$reported_fusion, pizzly.fusions$fusions_abundant, pizzly.fusions$fusions_cancer, pizzly.fusions$reported_fusion_geneA, pizzly.fusions$reported_fusion_geneB, decreasing = TRUE), ]
```
...
fusion_annot <- cbind(fusion_annot1, fusion_annot2, pizzly.fusions.annot[, c("reported_fusion", "fusions_abundant", "fusions_cancer", "reported_fusion_geneA", "reported_fusion_geneB")])
...
pizzly.fusions.cut <- pizzly.fusions.cut[ , c("geneA.name", "geneB.name", "paircount", "splitcount", "reported_fusion", "FGID", "geneA_dna_support", "geneB_dna_support", "fusions_abundant", "fusions_cancer", "reported_fusion_geneA", "reported_fusion_geneB") ]
```
...
names(pizzly.fusions.table) <- c("Gene A", "Gene B", "Pair count", "Split count", "Reported fusion", "DNA support (gene A)", "DNA support (gene B)", "Abundant transcript(s)", "Cancer gene(s)", "Fusion gene (A)", "Fusion gene (B)")
