...
`r if ( runClinicalChunk ) { c("***") } else { c(" ") }`

`r if ( runClinicalChunk ) { c("## Clinical information") } else { c(" ") }`

`r if ( runClinicalChunk ) { c("#### Treatment timeline") } else { c(" ") }`

`r if ( runClinicalChunk ) { c("NOTE: for confidentiality reasons, the start of the timeline (*x-axis*) projecting patient's treatment regimens (*y-axis*) is set to 1st January 2000, but the treatments lengths are preserved.") } else { cat(" ") }`
