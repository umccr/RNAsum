...
exprTable <- function(genes, data, targets, genes_annot = NULL) {
  ...
  DT::datatable( data = group.z, filter="none", rownames = FALSE, options = list(pageLength = 10), caption = htmltools::tags$caption(
          ...
          font-size:100% ;', "Standardised (Z-score) mRNA expression levels in individual groups; red = high; blue = low expression") ) %>%
...
exprTable(unlist(ref_genes.list[["genes_pmcc"]]), data, target, ref_datasets.list[[ref]][[5]][, c(1,3)])
```
