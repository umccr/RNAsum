...
for( i in 1:genes_no ){
  if ( genes[i] %in% rownames(data) ) {
    ...
    cat("<font size=\"2\">\n")
    cat(paste0("**Top panel**: cumulative distribution function (CDF) plot illustrating the proportion (*y-axis*) of values less than or equal to expression levels (Z-scores, *x-axis*) of *", genes[i], "* in patient's sample (*black dot*) and other reference cancer cohort(s) (median value).\n\n"))
    cat(paste0("**Bottom panel**: box-plot presenting expression level (Z-score) of *", genes[i], "* in patient's sample (*black dot*) and expression levels observed across samples from other reference cancer cohort(s).\n"))
    cat("\n</font>\n")
    cat("\n</details>\n")
    cat("<br />")
    cat("\n<details>\n")
