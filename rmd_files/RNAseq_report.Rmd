...
exprTable <- function(genes, data, targets, sampleName, normal, cancer, genes_annot = NULL, OncoKB_genes = NULL, tiers) {
...
mut_genes.expr <- exprTable(unique(ref_genes.list[["pcgr"]]$SYMBOL), data, target, params$sample_name, normal_group , cancer_group, ref_datasets.list[[tissue]][[5]][, c(1,3)], ref_genes.list[["oncokb_genes"]], ref_genes.list[["pcgr"]][, c("SYMBOL", "TIER")])
