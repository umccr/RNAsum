...
Gene fusion events detected in transcriptome data are prioritised based on criteria ranked in the following order:

1. Listed as **reported** fusion event according to [FusionGDB](https://ccsm.uth.edu/FusionGDB){target="_blank"} database

2. Involvement of fusion gene(s) **detected in genomic data** (if [Structural variants] results are available)
...
6. Involvement of **[cancer gene(s)](https://trello.com/c/7j3KFMiL/184-umccr-cancer-genes){target="_blank"}** (see [Cancer genes] section)
...
4. Select fusion events involving transcripts with [TPM](http://www.arrayserver.com/wiki/index.php?title=TPM){target="_blank"} values above 90th percentile of all [TPM](http://www.arrayserver.com/wiki/index.php?title=TPM){target="_blank"} values (as reported by previous step)
...
if ( nrow(fusion_annot_top) > 0 ) {
  ...
  fusion_annot_top.clean <- fusion_annot_top[, c("SYMBOL", "SEQNAME", "GENESEQSTART", "GENESEQEND", "SYMBOL.1", "SEQNAME.1", "GENESEQSTART.1", "GENESEQEND.1", "paircount", "splitcount", "reported_fusion", "geneA_dna_support", "geneB_dna_support", "fusions_abundant", "fusions_cancer") ]
  ...
  names(fusion_annot_top.clean) <- c("Gene A", "Chrom (A)", "Start (A)", "End (A)", "Gene B", "Chrom (B)", "Start (B)", "End (B)", "Pair count", "Split count", "Reported fusion", "DNA support (gene A)", "DNA support (gene B)", "Abundant transcript(s)", "Cancer gene(s)")
