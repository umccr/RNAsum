...
cdfPlot <- function(gene, data, targets, sampleName) {
  ...
  p <- plot_ly(sample.expr.cum, x = ~expression, color = I("black")) %>%
    ...
    ##### Add quantile lines
    add_lines(y = seq(0,1,0.1), x = rep(quantile(sample.expr, probs=0:4/4)[2], 11), opacity = 0.5,
              line = list(color = "gray", opacity = 0.2, dash = "dash"),
              name = "Q1", showlegend = FALSE) %>%
    
    add_lines(y = seq(0,1,0.1), x = rep(quantile(sample.expr, probs=0:4/4)[3], 11), opacity = 0.5,
              line = list(color = "gray", opacity = 0.2, dash = "dash"),
              name = "Q2", showlegend = FALSE) %>%
    
    add_lines(y = seq(0,1,0.1), x = rep(quantile(sample.expr, probs=0:4/4)[4], 11), opacity = 0.5,
              line = list(color = "gray", opacity = 0.2, dash = "dash"),
              name = "Q3", showlegend = FALSE) %>%
    
    layout(xaxis = list(title = "mRNA expression", zeroline = FALSE, range = c(min(sample.expr), max(sample.expr)+4)),
...
Empirical cumulative distribution function (ECDF) plot illustrating mRNA expression level of ***`r pizzly.fusions2$geneA.name[1]`*** and ***`r pizzly.fusions2$geneB.name[1]`*** in the context of the overall mRNA expression distribution in sample **`r params$sample_name`** and samples representing various pancreas-related lesions/tissues.
...
gene <- pizzly.fusions2$geneA.name[1]
cdfPlot(gene, data, target, params$sample_name)

gene <- pizzly.fusions2$geneB.name[1]
cdfPlot(gene, data, target, params$sample_name)
...
Table with of ***`r pizzly.fusions2$geneA.name[1]`*** and ***`r pizzly.fusions2$geneB.name[1]`*** annotation and mRNA expression levels in sample **`r params$sample_name`** and average mRNA expression across samples representing different pancreas-related lesions and tissues.
...
Empirical cumulative distribution function (ECDF) plot illustrating mRNA expression level of ***`r pizzly.fusions2$geneA.name[2]`*** and ***`r pizzly.fusions2$geneB.name[2]`*** in the context of the overall mRNA expression distribution in sample **`r params$sample_name`** and samples representing various pancreas-related lesions/tissues.
...
gene <- pizzly.fusions2$geneA.name[2]
cdfPlot(gene, data, target, params$sample_name)

gene <- pizzly.fusions2$geneB.name[2]
cdfPlot(gene, data, target, params$sample_name)
...
Empirical cumulative distribution function (ECDF) plot illustrating mRNA expression level of ***`r pizzly.fusions2$geneA.name[3]`*** and ***`r pizzly.fusions2$geneB.name[3]`*** in the context of the overall mRNA expression distribution in sample **`r params$sample_name`** and samples representing various pancreas-related lesions/tissues.
...
gene <- pizzly.fusions2$geneA.name[3]
cdfPlot(gene, data, target, params$sample_name)

gene <- pizzly.fusions2$geneB.name[3]
cdfPlot(gene, data, target, params$sample_name)
