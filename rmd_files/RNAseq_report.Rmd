...
##### Clean the space and return output
rm(quant, pizzly.fusion.candidates, pizzly.fusion.transcripts, quant.fusions.only.transcripts, known_translocations.CGI, known_translocations.FusionGDB, result, result.cancer_genes, result.other_genes)
```

```{r fusions_reads, comment = NA, message=TRUE, warning=FALSE, eval = deduped.status}
...
##### Clean the space
rm(deduped.result, quant.sorted.filtered, fusion_reads_inter)
```
...
```{r fusion_tables_1, comment = NA, message=TRUE, warning=FALSE, eval=deduped.status}
...
```{r fusion_tables_2, comment = NA, message=TRUE, warning=FALSE, eval=deduped.status}
##### Present a table with number of reads supporting this fusion
##### Check if the fusion has abundant transcript(s)
fusion_reads.top <- fusion_reads[ fusion_reads$geneA.name == geneA & fusion_reads$geneB.name == geneB, ]
...
```{r fusion_3_table, comment = NA, message=TRUE, warning=FALSE, eval=deduped.status}
##### Present a table with number of reads supporting this fusion
##### Check if the fusion has abundant transcript(s)
fusion_reads.top <- fusion_reads[ fusion_reads$geneA.name == geneA & fusion_reads$geneB.name == geneB, ]
...
```{r fusion_4_table, comment = NA, message=TRUE, warning=FALSE, eval=deduped.status}
##### Present a table with number of reads supporting this fusion
##### Check if the fusion has abundant transcript(s)
fusion_reads.top <- fusion_reads[ fusion_reads$geneA.name == geneA & fusion_reads$geneB.name == geneB, ]
...
```{r fusion_5_table, comment = NA, message=TRUE, warning=FALSE, eval=deduped.status}
##### Present a table with number of reads supporting this fusion
##### Check if the fusion has abundant transcript(s)
fusion_reads.top <- fusion_reads[ fusion_reads$geneA.name == geneA & fusion_reads$geneB.name == geneB, ]
