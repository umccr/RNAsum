...
for( i in 1:genes_no ) {
  ...
  if ( file.exists(gsub(":", ".", paste0(params$report_dir, "/results/arriba/", paste0(paste(geneA, geneB, sep = "__"), "_", breakpointA, "-", breakpointB), ".png"))) ) {
    cat("\n##### Fusion genes visualisation\n")

    ##### Present Arriba plots it in the report
    cat(paste0("![](", gsub(":", ".", paste0(params$report_dir, "/results/arriba/", paste0(paste(geneA, geneB, sep = "__"), "_", breakpointA, "-", breakpointB), ".png)"))), "\n")
    cat("\n***\n")
  }
