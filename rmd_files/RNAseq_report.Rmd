...
pizzly.fusions.cut <- pizzly.fusions.cut[ , c("geneA.name", "geneB.name", "paircount", "splitcount", "fusions_abundant", "fusions_cancer", "geneA_dna_support", "geneB_dna_support", "Reported", "Effector_gene", "Source", "Cancer_acronym") ]
...
names(pizzly.fusions.table) <- c("Gene A", "Gene B", "Pair count", "Split count", "Abundant transcript(s)", "Cancer gene(s)", "DNA support (gene A)", "DNA support (gene B)", "Fusion gene(s)", "Effector gene", "Source", "Cancer acronym")
...
fusion_annot_top.clean <- fusion_annot_top[, c("SYMBOL", "SEQNAME", "GENESEQSTART", "GENESEQEND", "SYMBOL.1", "SEQNAME.1", "GENESEQSTART.1", "GENESEQEND.1", "pizzly.fusions.annot.fusions_abundant", "pizzly.fusions.annot.fusions_cancer", "geneA_dna_support", "geneB_dna_support") ]
...
names(fusion_annot_top.clean) <- c("Gene A", "Chrom (A)", "Start (A)", "End (A)", "Gene B", "Chrom (B)", "Start (B)", "End (B)", "Abundant transcript(s)", "Cancer gene(s)", "DNA support (gene A)", "DNA support (gene B)")
