utils::globalVariables(c(".","caner_genes_annot.list", "ext_cancer_group", "int_cancer_group", "comp_cancer_group", "PlotsDir", "sd", "caller", "AF_BPI",
                         ...
                         "PURPLE_status", "SR (ref)", "PR (ref)", "PR (alt)", "PE", "PE (ref)", "somaticscore", "Transcript", "Other effects", "Other affected genes", "AF_PURPLE1",
