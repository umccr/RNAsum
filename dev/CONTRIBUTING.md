...
This outlines how to propose a change to RNAsum. For a detailed
...
review principles](https://code-review.tidyverse.org/) from the
tidyverse team.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("umccr/RNAsum", fork = TRUE)`.
...
Please note that the RNAsum project is released with a [Contributor Code
of Conduct](https://umccr.github.io/RNAsum/dev/CODE_OF_CONDUCT.md). By
