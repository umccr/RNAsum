...
detected using genomic data (e.g. from WGS pipeline). This
section is available only for samples with available SV results.

### CN altered genes

Section overlaying the mRNA expression data for cancer genes with per-gene
somatic copy-number (CN) data and mutation status, if available.
