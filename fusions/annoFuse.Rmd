...
Arribainputfile <- read_tsv("~/Documents/UMCCR/data/fusions/arriba/SBJ00051_MDX190040_SFRC01112_T_RNA_L1900448/fusions.tsv", col_types = cols())
...
The following is the quick peice of code to preare Arriba's input fusions calls for FusionAnnotator. 

```{r prepare-FA-input, warning = FALSE}
Arribainputfile %>%
    dplyr::mutate(FusionName = paste0(gene1, "--", gene2, sep = '')) %>%
    dplyr::select(FusionName, everything()) %>%
