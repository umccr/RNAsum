...
suppressMessages(library(annoFuse))
...
Arribainputfile <- read_tsv("~/Documents/UMCCR/data/fusions/arriba/SBJ00051_MDX190040_SFRC01112_T_RNA_L1900448/fusions.tsv")
#arriba output file has a # in the first coloumn. Removing it, otherwise the first column name become s"#gene1" instead of "gene"
names(Arribainputfile)[names(Arribainputfile) == "#gene1"] <- "gene1"

#pre-processing - adding "Sample", "Caller" and "annots" coloumn. Skipping FusionAnnotations annotation and adding an empty "annots" field.
Arribainputfile$Sample <- "SFRC01112"
Arribainputfile$Caller <- "Arriba"
Arribainputfile$annots <- "NA"

#the input looks like
head(Arribainputfile)
```
...
```{r standardize-calls, echo = FALSE}
