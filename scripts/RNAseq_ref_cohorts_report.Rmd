...
- add [14 metastatic PC](https://met500.path.med.umich.edu/datasets) samples from [MET500 project](https://met500.path.med.umich.edu/) published by [Dan R. Robinson et al. (2017)](https://www-nature-com.ezp.lib.unimelb.edu.au/articles/nature23306), 244 (?) normal pancreas samples from [recount2](https://www.bioconductor.org/help/course-materials/2017/BioC2017/Day1/Workshops/RNAseq/doc/recount-workshop.html) to the *pancreas-related* dataset



### Distant

The expression profile of investigated sample (**red**) was projected against unrelated tumour types, including (1) *acute myeloid leukaemia*, (2) *brain lower grade glioma*, (3) *breast invasive carcinoma*, (4) *glioblastoma multiforme*, (5) *lung Squamous cell carcinoma* and (6) *pancreatic ductal adenocarcinoma* (*PDAC*).
...
The expression profile of investigated sample (**red**) was projected against *developmental gastrointestinal* tumours, including (1) *liver hepatocellular carcinoma*, (2) *cholangiocarcinoma* and (3) *pancreatic ductal adenocarcinoma* (*PDAC*) (as defined in the [TCGA PanCan paper](https://www.ncbi.nlm.nih.gov/pubmed/29625048)).
...
The expression profile of investigated sample (**red**) was projected against *pancreas-related lesions and tissues*, including (1) *intraductal papillary mucinous neoplasm* (*IPMN)*, (2) *pancreatic neuroendocrine tumour* (*PanNET)* and (3) *pancreatic ductal adenocarcinoma* (*PDAC*), (4) *metastatic PDAC*, as well as (5) *normal pancreas tissue*.
...
This classification includes two stromal-associated (*normal* and *activated stroma*) [2 tumour-associated subtypes](https://www.ncbi.nlm.nih.gov/pubmed/26343385). Here the malignant epithelial-associated subtypes are presented:
