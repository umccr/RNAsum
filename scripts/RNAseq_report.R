...
#
#	  Command line use example: Rscript  RNAseq_report.R  --sample_name ./CCR170012_MH17T001P013_report  --count_file ./data/CCR170012_MH17T001P013-ready.counts  --report_dir /reports
#
...
if ( is.na(opt$sample_name) || is.na(opt$count_file) || is.na(opt$report_dir) ) {
  ...
  cat("\ncommand example:\n\nRNAseq_report.R --sample_name CCR170012_MH17T001P013 --count_file ./data/CCR170012_MH17T001P013-ready.counts --report_dir /reports\n\n")
